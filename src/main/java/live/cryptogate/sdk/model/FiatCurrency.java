 ...
 */
@JsonAdapter(FiatCurrency.Adapter.class)
public enum FiatCurrency {
  ...
  public static class Adapter extends TypeAdapter<FiatCurrency> {
    @Override
    public void write(final JsonWriter jsonWriter, final FiatCurrency enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public FiatCurrency read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return FiatCurrency.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    FiatCurrency.fromValue(value);
  }
}
