 ...
 */
@JsonAdapter(PlanTier.Adapter.class)
public enum PlanTier {
  ...
  public static class Adapter extends TypeAdapter<PlanTier> {
    @Override
    public void write(final JsonWriter jsonWriter, final PlanTier enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public PlanTier read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return PlanTier.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    PlanTier.fromValue(value);
  }
}
