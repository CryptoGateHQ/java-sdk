...
import live.cryptogate.sdk.auth.Authentication;
import live.cryptogate.sdk.auth.HttpBasicAuth;
import live.cryptogate.sdk.auth.HttpBearerAuth;
import live.cryptogate.sdk.auth.ApiKeyAuth;
...
public class ApiClient {
    ...
    private String basePath = "https://api.cryptogate.live/v1";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://api.cryptogate.live/v1",
      "Production (live keys, mainnet)",
      new HashMap<String, ServerVariable>()
    ),
    new ServerConfiguration(
      "https://api.staging.cryptogate.live/v1",
      "Sandbox (test keys, no real funds)",
      new HashMap<String, ServerVariable>()
    )
  ));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.cryptogate.live/v1
     ...
     * @return a {@link live.cryptogate.sdk.ApiClient} object
     */
    ...
    */
     ...
     * @throws live.cryptogate.sdk.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws live.cryptogate.sdk.ApiException If fail to serialize the given object
     */
     ...
     * @throws live.cryptogate.sdk.ApiException If fail to read file content from response and write to disk
     ...
     * @throws live.cryptogate.sdk.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws live.cryptogate.sdk.ApiException If the response has an unsuccessful status code or
     ...
     * @throws live.cryptogate.sdk.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws live.cryptogate.sdk.ApiException If fails to update the parameters
     */
     ...
     * @throws live.cryptogate.sdk.ApiException If fail to serialize the request body object into a string
     */
